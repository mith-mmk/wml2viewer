...
fn en(key: UiTextKey) -> &'static str {
    match key {
        ...
        UiTextKey::FolderRefresh => "Folder refresh",
        UiTextKey::Manual => "Manual",
        ...
        UiTextKey::Transition => "Transition",
        UiTextKey::TransitionEffect => "Effect",
        UiTextKey::TransitionDurationMs => "Duration (ms)",
        UiTextKey::Fade => "Fade",
        UiTextKey::SlideRightToLeft => "Slide R2L",
        UiTextKey::SlideLeftToRight => "Slide L2R",
        UiTextKey::SlideTopToBottom => "Slide T2B",
        UiTextKey::SlideBottomToTop => "Slide B2T",
        UiTextKey::SpiralWipeIn => "Spiral in",
        UiTextKey::SpiralWipeOut => "Spiral out",
...
fn ja(key: UiTextKey) -> &'static str {
    match key {
        ...
        UiTextKey::FolderRefresh => "フォルダ更新",
        UiTextKey::Manual => "手動",
        ...
        UiTextKey::Solid => "単色",
        UiTextKey::Shadow => "影",
        UiTextKey::Transition => "切り替え効果",
        UiTextKey::TransitionEffect => "効果",
        UiTextKey::TransitionDurationMs => "時間 (ms)",
        UiTextKey::Fade => "フェード",
        UiTextKey::SlideRightToLeft => "スライド 右から左",
        UiTextKey::SlideLeftToRight => "スライド 左から右",
        UiTextKey::SlideTopToBottom => "スライド 上から下",
        UiTextKey::SlideBottomToTop => "スライド 下から上",
        UiTextKey::SpiralWipeIn => "渦巻き表示",
        UiTextKey::SpiralWipeOut => "渦巻き消去",

...
fn en(key: UiTextKey) -> &'static str {
    match key {
        ...
        UiTextKey::InputKeyboardOnlyNotice => {
            "Keyboard remap is available now. Mouse/tablet remap is planned."
        }
        ...
        UiTextKey::PressKeyToAssign => "Click the key box and press a key",
        ...
        UiTextKey::PrevImageAction => "Previous Image",
        ...
        UiTextKey::ToggleMangaModeAction => "Toggle Manga Mode",
        UiTextKey::ToggleSettingsAction => "Toggle Settings",
        UiTextKey::ToggleFilerAction => "Toggle Filer",
        UiTextKey::ToggleSubfilerAction => "Toggle Subfiler",
        UiTextKey::SaveAsAction => "Save As",
    }
}
...
fn ja(key: UiTextKey) -> &'static str {
    match key {
        ...
        UiTextKey::InputKeyboardOnlyNotice => {
            "現在はキーボード割り当てに対応。マウス/タブレットは今後対応予定です。"
        }
        ...
        UiTextKey::PressKeyToAssign => "キー欄をクリックして、割り当てたいキーを押してください",
        ...
        UiTextKey::PrevImageAction => "前の画像",
        ...
        UiTextKey::ToggleMangaModeAction => "マンガモード切替",
        UiTextKey::ToggleSettingsAction => "設定画面を切替",
        UiTextKey::ToggleFilerAction => "ファイラーを切替",
        UiTextKey::ToggleSubfilerAction => "サブファイラーを切替",
        UiTextKey::SaveAsAction => "名前を付けて保存",
    }
}
